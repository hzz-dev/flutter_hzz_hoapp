...
import 'package:flutter_hzz_hoapp/src/pages/common/common_webview.dart';
...
class ProtocolModel {
  ...
  void openUserProtocol(BuildContext context) {
    ...
    NavigatorUtils.pushPage(
      ...
      targPage: CommonWebViewPage(
        pageTitle: "用户协议",
        htmlUrl: "https://jdc.jd.com/archives/213013",
      ),
    );
  }
  ...
  void openPrivateProtocol(BuildContext context) {
    ...
    NavigatorUtils.pushPage(
      ...
      targPage: CommonWebViewPage(
        pageTitle: "隐私协议",
        htmlUrl: "https://jdc.jd.com/archives/213007",
      ),
    );
  }
}
